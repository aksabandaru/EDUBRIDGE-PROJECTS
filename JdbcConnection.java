...
public class JdbcConnection  {
	...
	public static void update(Connection connection,int software_id) throws SQLException {
		PreparedStatement pstmt = connection.prepareStatement("update  softwaredetails set  price=? where software_id=?");
...
while(record.next()) {
	...
	public static void main(String[] args)throws SQLException, Exception{
		...
		connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/employeetdetails", "root" ,"Ca@aksa44");
